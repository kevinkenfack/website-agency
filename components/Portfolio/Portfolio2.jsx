            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                        <h2 className="display-3 fw-semi-bold uppercase">Our Recent Works</h2>
                    </div>
                </div>
                            ...
                            <div className="portfolio-box" data-hover-text="view project">
                                <Link href={item.slug}>
                                    ...
                                    <div className="d-flex pt-3 justify-content-between align-items-start">
                                        <h3>{item.title}</h3>
                                        <span className="d-inline-block py-2 px-3 bg-white-10 rounded-pill sm-heading text-white-80">{item.category}</span>
                                    </div>
                                </Link>
                            </div>
                        </div>

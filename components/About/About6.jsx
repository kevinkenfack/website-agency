            ...
            <div className="container">
                <div className="row align-items-center custom-row">
                            ...
                            <div className="col-6 text-end">
                                <div data-bottom-top="transform: translateY(10px)" data-top-bottom="transform: translateY(-36px)">
                                    ...
                                    <div className="d-flex align-items-center mt-1">
                                        ...
                                        <div className="h2 display-3 fw-normal ps-3"><span className="text-gradient-5">{data.number}</span></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="col-12 col-lg-6 custom-col">
                        ...
                        <a className="button button-lg button-dark button-rounded button-hover-slide mt-4" href={data.button.href} data-cue="fadeIn">

import { Clients7, Cursor, Footer1, HeaderNavLeft, ScrollToTop, Testimonial2 } from '@/components';
...
export default function PageCorporateClients() {
    ...
    return (
        <>
            ...
            <main>
                            ...
                            <div className="container text-center">
                                <div className="row g-4">
                                    <div className="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                                        <h1 className="display-3 fw-medium text-center mb-0">Meet Our Clients</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* Clients */}
                <Clients7 data={clientsData.corporateClients} />

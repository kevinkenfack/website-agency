import { About8, BackgroundVerticalLines,  Cursor, Footer3, HeaderNavLeft2, ScrollToTop, Services5, Testimonial4 } from '@/components';
    ...
    return (
        <>
            ...
            <main>
                            ...
                            <div className="container text-center">
                                <div className="row g-4">
                                    <div className="col-12 col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
                                        <h1 className="display-3 fw-semi-bold uppercase text-center mb-0">What We Do</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* About */}
                <About8 data={aboutData.startupServices} gradient5 />
                ...
                {/* Testimonial */}
                <Testimonial4 data={testimonialData.startupServices} className="pt-0" />

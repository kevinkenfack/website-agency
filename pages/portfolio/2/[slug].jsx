...
import { BackgroundVerticalLines, Cursor, Footer6, HeaderFullscreenMenu1, HeaderFullscreenMenu2, HeaderFullscreenMenu3, HeaderFullscreenMenu4, HeaderFullscreenMenu5, HeaderNavLeft3, ScrollToTop, SimilarProjects } from '@/components';
import { headerData } from '@/components/Header/HeaderData';
import { footerData } from '@/components/Footer/FooterData';

const PagePortfolioSingle2 = ({ project }) => {
    ...
    return (
        <>
            ...
            <main>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12 col-lg-10 offset-lg-1">
                                <h1 className="display-3 font-family-tertiary fw-normal fst-italic text-dark-30 text-center">{project.title}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="bg-gray text-center pb-1">
                    <div className="container">
                        <div className="row g-0">
                            <div className="col-6 col-lg-3">
                                <div className="px-4 pb-4">
                                    <span className="d-block sm-heading text-dark">Services</span>
                                    <span>{project.services.map(service => service.name).join(', ')}</span>
                                </div>
                            </div>
                            <div className="col-6 col-lg-3">
                                <div className="px-4 pb-4">
                                    <span className="d-block sm-heading text-dark">Client</span>
                                    <span>{project.client}</span>
                                </div>
                            </div>
                            <div className="col-6 col-lg-3">
                                <div className="px-4 pb-4">
                                    <span className="d-block sm-heading text-dark">Duration</span>
                                    <span>{project.duration}</span>
                                </div>
                            </div>
                            <div className="col-6 col-lg-3">
                                <div className="px-4 pb-4">
                                    <span className="d-block sm-heading text-dark">Project Link</span>
                ...
                {/* Similar Posts */}
                <SimilarProjects className="bg-gray" />
...
export default PagePortfolioSingle2